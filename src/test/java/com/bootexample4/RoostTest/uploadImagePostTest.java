...
.pathParam("file", ...)
            ...
            if (response.jsonPath().get("code") != null) {        
              assertThat(response.jsonPath().get("code"), instanceOf(Integer.class));      
          }
          
            if (response.jsonPath().get("type") != null) {        
              assertThat(response.jsonPath().get("type"), instanceOf(String.class));      
          }
